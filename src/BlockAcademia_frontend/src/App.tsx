...
import * as backend from "../../declarations/BlockAcademia_backend"
...
function App() {
  ...
  const [userDaoMember, setUserDaoMember] = useState(false);
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (isConnected) {
        const hasRights = await rightToVote()
      setUserDaoMember(hasRights);
      }
    };
    fetchData();
